        ...
        <Header className="main-header-layout" id='main-menu'>
            ...
            <Col span={12}>
                <Steps size="small">
                    ...
                    <Step onClick={handleCalculatorStep} className={`application-steps application-steps-wait ${ stepType === 'calculator' && 'application-steps-process'}`} status="wait" title="Calculator" icon={<Icon component={ CalculatorSvg } />} />
