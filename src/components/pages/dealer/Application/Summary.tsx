              ...
              <Collapse>
                ...
                >
                  <Divider orientation="left">
                    <span className="divider">Personal</span>
                  </Divider>
                  ...
                  <Divider orientation="left">
                    <span className="divider">Home Address</span>
                  </Divider>
                  ...
                  <Divider orientation="left">
                    <span className="divider">Mailing Address</span>
                  </Divider>
                  ...
                  <Divider orientation="left">
                    <span className="divider">Employment Details</span>
                  </Divider>
